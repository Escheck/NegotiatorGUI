 ...
 * @author  W.Pasman
 */
public class EnterBidDialogOfferForVoting extends JDialog implements EnterBidDialogInterface {
    ...
    public EnterBidDialogOfferForVoting(NegotiationParty party, Frame parent, boolean modal, UtilitySpace us)  throws Exception
    {
        super(parent, modal);
        this.party = party;
