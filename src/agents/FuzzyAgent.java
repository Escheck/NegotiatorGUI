...
//	private static double MaxS2=40;
	...
	{
		double cost;
		cost=(double)(java.lang.Math.exp(NoIteration*constant)-java.lang.Math.exp(-NoIteration*constant))/(double)(java.lang.Math.pow(java.lang.Math.E,NoIteration*constant)+java.lang.Math.pow(java.lang.Math.E,-NoIteration*constant));
		return cost;
	}
	 protected static boolean Buyer(int i){
		...
		switch (tacticB){
		    ...
		    //if it has not reached the deadline continue negotiation
			    ...
			    Utl=(double)(MaxB-SellOffer[i-1][0])/(double)(MaxB-MinB);
			    if (i>0){
				    Utl=(double)(MaxB-SellOffer[i-1][0])/(double)(MaxB-MinB);
				    if (CSell==false){
					    /* if (((double)SellOffer[i-1][0]<=(double)BuyOffer[i-1][1]) && (i<deadlineB))
					    {
						    System.out.println("Accepted");
						    AcceptedValue=SellOffer[i-1][0];
						    return true;
					    } */
					    if (((double)SellOffer[i-1][1]<=(double)BuyOffer[i-1][1]) && (i<=deadlineB))
					    {
						    double[] xParams={SellOffer[i-1][1],SellOffer[i-1][0],BuyOffer[i-1][0],BuyOffer[i-1][1]};
						    if ((double)BuyOffer[i-1][1]==(double)BuyOffer[i-1][0]){
							    CBuy=false;
					   	    }
						    else
						    {
							   ...
							   //Checks if the the intersection pointis lower than the threshhold, if so agent will
			    ...
			    if (BBuy==0.01 || BBuy==0.2){
				    A=java.lang.Math.exp(java.lang.Math.pow(1-((double)java.lang.Math.min(i+1,deadlineB)/(double)deadlineB),(BBuy))*java.lang.Math.log(K));
			    }
			    else{
				    A=K+((1-K)*(java.lang.Math.pow(((double)java.lang.Math.min(i+1,deadlineB)/(double)deadlineB),(1/BBuy))));
			    }
			    double tmp=MinB+((MaxB-MinB)*A);
			    double tmpUtl=(double)(MaxB-tmp)/(double)(MaxB-MinB);
			    if (CSell==true && i>=2){
			    ...
			    else
			    {
				    ...
				    {
					    BuyOffer[i][0]=(double)tmp;
					    //code added to calculate the stretch reduction
					    if (BBuyStretch==0.01 || BBuyStretch==0.2){
						    A=java.lang.Math.exp(java.lang.Math.pow(1-((double)java.lang.Math.min(i+1,deadlineB)/(double)deadlineB),(BBuyStretch))*java.lang.Math.log(K));
						    
					    }
					    else{
						    A=K+((1-K)*(java.lang.Math.pow(((double)java.lang.Math.min(i+1,deadlineB)/(double)deadlineB),(1/BBuyStretch))));
					    }
					    double tmpBcons=((percentageB2*(Bcons))+((percentageB1-percentageB2)*(Bcons)*(1-A)));
		    ...
		    if (i>deadlineB){
			    ...
			    if (i>0){ 
				    ...
				    if (CSell==false){
					    ...
					    if (((double)SellOffer[i-1][1]<=(double)BuyOffer[i-1][1]) && (i<=deadlineB))
					    {
						    ...
						    if ((double)BuyOffer[i-1][0]==(double)BuyOffer[i-1][1]){
							    CBuy=false;
					   	    }
						    else
						    {
							   ...
							   double[] yParams={0.0,1.0,1.0,0.0};
							   inter=Intersection(xParams, yParams);
							   double DifUtlOurs=(double)(MaxB-BuyOffer[i-1][0])/(double)(MaxB-MinB);
							   double MidUtl=(double)(MaxB-inter[0])/(double)(MaxB-MinB);
							   DifUtlOurs-=MidUtl;
							   double DifUtlOps=(double)(MaxB-SellOffer[i-1][0])/(double)(MaxB-MinB); 
			    ...
			    if (LBuy==3){
				    ...
				    if (i>LBuy){
					     //double tmp3=java.lang.Math.min(java.lang.Math.max((BuyOffer[i-1][0]+(double)SellOffer[i-1-LBuy][0]-(double)SellOffer[i-1][0]+(generator.nextInt(4))),MinB),MaxB);
					     double tmp3=java.lang.Math.min(java.lang.Math.max((BuyOffer[i-1][0]+(double)SellOffer[i-1-LBuy][0]-(double)SellOffer[i-1][0]+2),MinB),MaxB);
					     double tmpUtl3=(double)(MaxB-tmp3)/(double)(MaxB-MinB);
					     if (((float)tmpUtl3<=(float)Utl) && (CBuy==false)){
						    //System.out.println("Accepted");
						    AcceptedValue=SellOffer[i-1][0];
						    return true;
				   	    }	
			    ...
			    {
				    if (i>LBuy){
					    double tmp2=java.lang.Math.min(java.lang.Math.max(((double)SellOffer[i-1-LBuy][0]/(double)SellOffer[i-1][0])*BuyOffer[i-1][0],MinB),MaxB);
					    // double tmp3=java.lang.Math.min(java.lang.Math.max((BuyOffer[i-1][0]+(double)SellOffer[i-1-LBuy][0]-(double)SellOffer[i-1][0]+2),MinB),MaxB);
					    //Utl=(double)(MaxB-SellOffer[i-1])/(double)(MaxB-MinB);
					    double tmpUtl2=(double)(MaxB-tmp2)/(double)(MaxB-MinB);
					    if (((float)tmpUtl2<=(float)Utl) && (CBuy==false)) {
						    //System.out.println("Accepted");
						    AcceptedValue=SellOffer[i-1][0];
						    return true;
		    ...
		    //if it has not reached the deadline continue negotiation
			    ...
			    double resource= new Double(MBuy*((double)1/(double)(i+1)));
			    A=K+((1-K)*(1/(java.lang.Math.exp(resource))));
			    double tmp4=MinB+((MaxB-MinB)*A);
			    double tmpUtl4=(double)(MaxB-tmp4)/(double)(MaxB-MinB);
	...
	protected static boolean Seller(int i){
		...
		switch (tacticS){
		    ...
		    //if it has not reached the deadline continue negotiation
			    ...
			    Utl=(double)(BuyOffer[i][0]-MinS)/(double)(MaxS-MinS);
			    if (i>0){
			       if (CBuy==false){
				       /* if (((double)SellOffer[i-1][1]<=(double)BuyOffer[i][0])&& (i<deadlineS))
				       {
					       System.out.println("Accepted");                       
					       AcceptedValue=BuyOffer[i-1][0];
					       return true;
				       } */
				       if (((double)SellOffer[i-1][1]<=(double)BuyOffer[i][1])&& (i<=deadlineS))
				       {
					        double[] xParams=new double[4];
						    if ((double)SellOffer[i-1][0]==(double)SellOffer[i-1][1]){
							    CSell=false;
					   	    }
						    else
						    {
			    ...
			    if (BSell==0.01 || BSell==0.2){
				    A=java.lang.Math.exp(java.lang.Math.pow((1-((double)java.lang.Math.min(i+1,deadlineS)/(double)deadlineS)),(BSell))*java.lang.Math.log(K));
			    }
			    else
			    {
				    A=K+((1-K)*(java.lang.Math.pow(((double)java.lang.Math.min(i+1,deadlineS)/(double)deadlineS),(1/BSell))));
			    }
			    double tmp=MinS+((MaxS-MinS)*(1-A));
			    double tmpUtl=(double)(tmp-MinS)/(double)(MaxS-MinS);
			    if (CBuy==true){
			    ...
			    else
			    {
				    ...
				    if (CSell==true){
					    ...
					    SellOffer[i][0]=(double)tmp;
					    //code added to calculate the stretch for fuzzy offers
					    if (BSellStretch==0.01 || BSellStretch==0.2){
						    A=java.lang.Math.exp(java.lang.Math.pow((1-((double)java.lang.Math.min(i+1,deadlineS)/(double)deadlineS)),(BSellStretch))*java.lang.Math.log(K));
					    }
					    else
					    {
						    A=K+((1-K)*(java.lang.Math.pow(((double)java.lang.Math.min(i+1,deadlineS)/(double)deadlineS),(1/BSellStretch))));
					    }
					    double tmpScons=((percentageS2*(Scons))+((percentageS1-percentageS2)*(Scons)*(1-A)));
		    ...
		    {	
				    ...
				    if (CBuy==false){
					       ...
					       if (((double)SellOffer[i-1][1]<=(double)BuyOffer[i][1])&& (i<=deadlineS))
					       {
						       ...
						       else
						       {
							       ...
							       double[] yParams={0.0,1.0,1.0,0.0};
							       inter=Intersection(xParams, yParams);
							       double DifUtlOurs=(double)(SellOffer[i-1][0]-MinS)/(double)(MaxS-MinS);
							   double MinUtl=(double)(inter[0]-MinS)/(double)(MaxS-MinS);
							   DifUtlOurs-=MinUtl;
							   double DifUtlOps=(double)(BuyOffer[i-1][0]-MinS)/(double)(MaxS-MinS);
							   DifUtlOps=Utl-DifUtlOps;
							   //if ((float)DifUtlOurs<=(float)DifUtlOps){
								   MaxS=inter[0];
								   CSell=true;
							...
							//	   CSell=false;
							 //  }
						       ...
						       /* double[] xParams={SellOffer[i-1][1],SellOffer[i-1][0],BuyOffer[i][0],BuyOffer[i][1]};
						       double[] yParams={0.0,1.0,1.0,0.0};
						       //double[] inter={};
						       inter=Intersection(xParams, yParams);
						       CSell=true;
			    ...
			    if (LSell==3){
				    ...
				    rand=2;
				    if (i>=LSell){
					    double tmp3=java.lang.Math.min(java.lang.Math.max((SellOffer[i-1][0]+BuyOffer[i-LSell][0]-BuyOffer[i][0]-rand),MinS),MaxS);
					    double tmpUtl3=(double)(tmp3-MinS)/(double)(MaxS-MinS);
					    if (((float)tmpUtl3<=(float)Utl) && (CSell==false)){
						    //System.out.println("Accepted");
						    AcceptedValue=BuyOffer[i][0];
						    return true;
					    }
			    ...
			    {	
				    if (i>=LSell){
					    ...
					    double tmp2=java.lang.Math.min(java.lang.Math.max(((double)BuyOffer[i-LSell][0]/(double)BuyOffer[i][0])*SellOffer[i-1][0],MinS),MaxS);
					    Utl=(double)(BuyOffer[i][0]-MinS)/(double)(MaxS-MinS);
					    double tmpUtl2=(double)(tmp2-MinS)/(double)(MaxS-MinS);
					    if (((float)tmpUtl2<=(float)Utl) && (CSell==false)){
						    //System.out.println("Accepted");
						    AcceptedValue=BuyOffer[i][0];
						    return true;
					    }
		    ...
		    //if it has not reached the deadline continue negotiation
			    ...
			    double resource= new Double(MSell*((double)1/(double)(i+1)));
			    A=K+((1-K)*(1/(java.lang.Math.exp(resource))));
			    double tmp4=MinS+((MaxS-MinS)*(1-A));
			    double tmpUtl4=(double)(tmp4-MinS)/(double)(MaxS-MinS);
	...
	*/
	public static double[] Intersection(double[] xPars,double[] yPars){
	    ...
	    double ua=0;
	    ua=(double)(((xPars[3]-xPars[2])*(yPars[0]-yPars[2]))-((yPars[3]-yPars[2])*(xPars[0]-xPars[2])))/(double)(((yPars[3]-yPars[2])*(xPars[1]-xPars[0]))-((xPars[3]-xPars[2])*(yPars[1]-yPars[0])));
	    double[] interPoint=new double[2];	
	    interPoint[0]=(double)(xPars[0]+((double)ua*(xPars[1]-xPars[0])));
	    interPoint[1]=(double)(yPars[0]+((double)ua*(yPars[1]-yPars[0])));
	    return interPoint; 		  
         }
	 ...
	 public static void FuzzyDist(){
		 ...
		 if (BuyOffer[iteration-1][0] != BuyOffer[iteration-1][1]){
		    midPointXB+=((double)((3*(java.lang.Math.pow(BuyOffer[iteration-1][0],2)*BuyOffer[iteration-1][1]))-java.lang.Math.pow(BuyOffer[iteration-1][1],3)-(2*java.lang.Math.pow(BuyOffer[iteration-1][0],3)))/(double)(6*(BuyOffer[iteration-1][0]-BuyOffer[iteration-1][1])));
		    midPointXB=midPointXB/((double)((2*BuyOffer[iteration-1][1]*BuyOffer[iteration-1][0])-java.lang.Math.pow(BuyOffer[iteration-1][1],2)-java.lang.Math.pow(BuyOffer[iteration-1][0],2))/(double)(2*(BuyOffer[iteration-1][0]-BuyOffer[iteration-1][1])));
		    midPointYB=0.5;
		 }
		 else
		 {
		 ...
		 if (SellOffer[iteration-1][0]!=SellOffer[iteration-1][1]){
		    ...
		    midPointXS+=((double)((3*(java.lang.Math.pow(SellOffer[iteration-1][1],2)*SellOffer[iteration-1][0]))-java.lang.Math.pow(SellOffer[iteration-1][0],3)-(2*java.lang.Math.pow(SellOffer[iteration-1][1],3)))/(double)(6*(SellOffer[iteration-1][0]-SellOffer[iteration-1][1])));
		    midPointXS=midPointXS/((double)((2*SellOffer[iteration-1][1]*SellOffer[iteration-1][0])-java.lang.Math.pow(SellOffer[iteration-1][1],2)-java.lang.Math.pow(SellOffer[iteration-1][0],2))/(double)(2*(SellOffer[iteration-1][0]-SellOffer[iteration-1][1])));
		    midPointYS=0.5;
		 }
		 else
		 {
		 ...
		 double last=java.lang.Math.sqrt(java.lang.Math.pow((midPointXS-midPointXB),2)+java.lang.Math.pow((midPointYS-midPointYB),2));
