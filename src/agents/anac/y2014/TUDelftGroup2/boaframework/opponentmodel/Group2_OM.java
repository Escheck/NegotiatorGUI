 ...
 * <p>
 * This {@code Group2_OM} uses a straightforward frequency analysis algorithm for weights estimation.
 * For calculating the evaluation function of the different options ({@code ValueDiscrete}) a simple counter is used.
 * @since 2013-12-13
 * @version 1.0 
 */
public class Group2_OM extends OpponentModel 
{
	 ...
	 * <p>
	 * This Initialization function sets the issue weights to equal values that sum up to 1
	 * and the option evaluations to 1, which means they are all equally important
	 * @param negotiationSession {Provided by framework} This contains all the session variables
	 * @param parameters {Provided by framework}
	 */
	@Override
...
//			 
	...
	public double getBidEvaluation(Bid bid) {
		...
		for (Issue issue : domain_issues) 
		{
			...
			// If the option in this issue was used more then expected, then say that this bid, in this issue, should be considered a good bid.
