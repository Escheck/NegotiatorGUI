			{ 8, 7, 9, 5, 6, 7, 5, 3, 7, 6 }, { 8, 7, 9, 5, 7, 7, 5, 4, 8, 7 },
			{ 8, 7, 9, 5, 7, 8, 3, 4, 8, 7 }, { 8, 7, 9, 5, 7, 8, 3, 5, 8, 7 },
			{ 8, 7, 9, 5, 7, 8, 5, 3, 8, 7 }, { 8, 7, 9, 5, 7, 8, 5, 5, 8, 6 },
			{ 8, 7, 9, 5, 7, 9, 4, 4, 8, 7 }, { 8, 7, 9, 5, 8, 8, 4, 4, 8, 7 },
			{ 8, 7, 9, 5, 9, 7, 5, 4, 8, 7 }, { 8, 7, 9, 6, 8, 8, 5, 6, 8, 6 },
			{ 8, 7, 9, 6, 8, 9, 4, 4, 8, 7 }, { 8, 7, 9, 6, 8, 9, 4, 5, 8, 7 },
			{ 8, 7, 9, 6, 8, 9, 5, 5, 8, 6 }, { 8, 8, 9, 4, 6, 6, 6, 4, 8, 7 },
			{ 8, 8, 9, 4, 6, 7, 4, 4, 8, 7 }, { 8, 8, 9, 4, 6, 7, 5, 5, 8, 7 },
			{ 9, 6, 9, 4, 8, 8, 4, 5, 8, 7 }, { 9, 6, 9, 4, 9, 8, 3, 5, 8, 7 },
			{ 9, 7, 9, 5, 7, 9, 4, 5, 8, 7 }, { 9, 7, 9, 5, 9, 7, 3, 5, 8, 7 },
			{ 9, 7, 9, 5, 9, 7, 4, 6, 8, 7 }, { 9, 7, 9, 6, 7, 9, 4, 5, 8, 7 } };
	 ...
	 */
	public BidSpaceExtractor_opening(NegotiationSession negotiationSession,
			OpponentModel opponentModel, OMStrategy opponentModelStrategy) {
	...
	private String pre_calculations(HashMap<java.lang.Integer, Value> bidP,
		...
		if (distrib == "competition_middle") {
			...
			if (counter_neighborhood == 0) {
				...
				List<BidDetails> block_of_history_in_focus = this.negotiationSession
						.getOpponentBidHistory().getHistory();
		...
		if (distrib == "nullspace around best bid") {
			...
			if (already_set_up_the_nullspace == false) {
				...
				BidDetails first_opp_bid = this.negotiationSession
						.getOpponentBidHistory().getFirstBidDetails();

				Integer[] ownbid = bidAsArray(this.best_past_exploration.get(0)
						.getBid());
				Integer[] opponentbid = bidAsArray(first_opp_bid.getBid());

				if (ownbid.length != opponentbid.length) {
					System.out
							.println("OWN AND OPPONENT HAVE DIFFERENT NUMBER OF ISSUES");
					return "";
				}
				...
				float[] tenth_of_diff = getInterpolationStepVector(NoSteps,
						diff);
				...
				List<BidDetails> path = new ArrayList<BidDetails>(
						this.max_issues);
				double valueoflast;
				...
				if (switch_to_opponentapproach) {
					...
					block_of_history_in_focus = block_of_history_in_focus
							.subList(st, ed);
		...
		if (distrib == "neighborhood") {
			...
			n_bid = org.apache.commons.lang.StringUtils.leftPad(
					Integer.toBinaryString(counter_neighborhood),
					this.max_issues, "0");
			...
			// -1
			if (neighbor_omni)
				n_bid = org.apache.commons.lang.StringUtils.leftPad(Integer
						.toString(random.nextInt((int) Math.floor(Math.pow(3,
								10))), 3), this.max_issues, "0");
		}

		if (distrib == "true_uniform") {
			n_bid = org.apache.commons.lang.StringUtils.leftPad(Integer
					.toString(
							random.nextInt((int) Math.floor(Math.pow(10, 10))),
							10), this.max_issues, "0");
		...
		if (distrib == "enumeration") {
			...
			n_bid = org.apache.commons.lang.StringUtils.leftPad(
					Integer.toString(counter_neighborhood, 3), this.max_issues,
					"0");
		}
		...
		if (distrib == "resampled_stoch_neighborhood"
			...
			if (counter_neighborhood == 0) {
				...
				BidDetails bidDetails_start = new BidDetails(bid_start,
						actualUtil);
			...
			int sample_direction = random.nextInt((int) Math.round(Math.pow(2,
					this.max_issues)));
			n_bid = org.apache.commons.lang.StringUtils.leftPad(
					Integer.toBinaryString(sample_direction), this.max_issues,
					"0");
			...
			if ((counter_neighborhood % exploration_length) == 0) {
				if (counter_neighborhood > 0) { // skip the first turn, since we
					...
					exploration_length = exploration_length_initial
							* particle_count;
					...
					if (distrib != "resampled_stoch_neighborhood_omni_end_corrected_particle_reachtop") {
						...
						//
						double lower_threshold = min_u + (max_u - min_u)
								* range_pct;
						...
						while (particles_selected < particle_count) {
							...
							BidDetails candidate = own_past_bids_recent_exploration
									.get(idx_candidate_particle);
							...
							// (distrib!="resampled_stoch_neighborhood_omni_end_corrected_particle_reachtop")
					{
						...
						BidHistory bh = new BidHistory(
								own_past_bids_recent_exploration);
						own_past_bids_recent_exploration = bh
								.getNBestBids(top_how_much);
	...
	private List<BidDetails> explore_block_of_history_AVS_flat(
			List<BidDetails> block_of_history_in_focus) throws Exception {
		Bid prtcl;
		...
		List<BidDetails> refined_list = new ArrayList<BidDetails>(
				this.max_issues * combing_particles_no);
		...
		for (int i = 0; i < combing_particles_no; i++) {
			...
			BidDetails prtcl_details = block_of_history_in_focus.get(random
					.nextInt(block_of_history_in_focus.size()));
			prtcl = prtcl_details.getBid();
	...
	private void put_uni_random_bid_into_best_past_exploration()
			throws Exception {
	...
	private List<BidDetails> next_best_into_best_past_exploration()
			throws Exception {
		Bid prtcl = best_past_exploration.get(0).getBid();
		// Bid saved_prtcl= new Bid( negotiationSession.getDomain() ,
		// prtcl.getValues());
	...
	private void aVerySmallRandomStepInEachSingleIssueForAllIssues_looped_10_times(
			Bid prtcl) throws Exception {
		...
		for (int i = 0; i < 10; i++) {
			...
			for (int j = this.min_issues; j < this.max_issues; j++) {
				...
				if (null_options_in_this_issue.size() != 0) {
					...
					Integer an_option = null_options_in_this_issue.get(random
							.nextInt(null_options_in_this_issue.size()));
	...
	private void aManyStepsInRandomDirectionsAtOnce_looped_270_times(Bid prtcl)
			throws Exception {
		Map<Integer, List<Integer>> nullspace;
		for (int i = 0; i < 3; i++) {
			// This will do the whole set of issues once, and then loop.
	...
	private Map<Integer, List<Integer>> get_nullspace(Bid prtcl)
			throws Exception {
		Map<Integer, HashMap<Integer, Double>> map = axes_lookahead_maps(prtcl);
		Map<Integer, List<Integer>> nullspace = new HashMap<Integer, List<Integer>>(
				this.max_issues);
																	...
																	// Issues
		{
			...
			if ((distrib == "competition_opening")
				...
				BidDetails one_particle = best_past_exploration
						.get(counter_neighborhood
								% best_past_exploration.size());
				...
				// issue?
				a = ((ValueInteger) one_particle.getBid().getValue(i))
						.getValue();
			...
			if (distrib == "neighborhood" || distrib == "enumeration") {
				...
				// System.out.println(n_bid);
				a = Character
						.getNumericValue(n_bid.charAt(i - this.min_issues));
			...
			if (distrib == "resampled_stoch_neighborhood") {
				...
				// issue?
				a = (int) Math.round(a
						+ ((ValueInteger) one_particle.getBid().getValue(i))
								.getValue());
			...
			if (distrib == "resampled_stoch_neighborhood_omni_end"
				...
				if (best_past_exploration.size() != 0) {
					one_particle = best_past_exploration
							.get(counter_neighborhood
									% best_past_exploration.size());
				} else {
