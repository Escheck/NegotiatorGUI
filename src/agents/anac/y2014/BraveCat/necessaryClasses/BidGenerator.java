...
public class BidGenerator
{
    ...
    private BidDetails searchBid() throws Exception 
    {
        ...
        ArrayList issues = negotiationSession.getDomain().getIssues();
        Bid bid = null;
        ...
        BidDetails bidDetails = new BidDetails(bid, this.negotiationSession.getUtilitySpace().getUtility(bid), this.negotiationSession.getTime());
        return bidDetails;
    }
    ...
    public BidDetails selectBid(double bidTarget) throws Exception
    {
        ...
        try
        {
            ...
            while (searchUtil < bidTarget)
            {
                ...
                nextBid = searchBid();
                searchUtil = negotiationSession.getUtilitySpace().getUtility(nextBid.getBid());
                loop++;
            }
        }
    ...
    public List<BidDetails> NBidsNearUtility(double bidTarget, int n) throws Exception
    {
