...
public class BraveCat extends BOAagent
{
    ...
    {
        System.out.println("..........................Agent Setup Started.............................");
        try {
            OpponentModel om = null;
            om = new DBOMModel();
            om.init(negotiationSession);
            OMStrategy oms = new BestBid(negotiationSession, om);
            OfferingStrategy offering = new BRTOfferingStrategy(this.negotiationSession, om, oms, 0.005, 0);               
        ...
        System.out.println("..........................Agent Setup Ended...............................");
    }
