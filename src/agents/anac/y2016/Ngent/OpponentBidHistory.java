...
public class OpponentBidHistory {
	...
	private HashMap<Bid, Integer> bidCounter;
	...
	public OpponentBidHistory() {
		...
		bidCounter = new HashMap<Bid, Integer>();
	}
	...
	protected void updateOpponentModel(Bid bidToUpdate, Domain domain,
		...
		try {
			...
			// System.setOut(file);
			// System.out.println("Enter updateOpponentModel!");
			// System.out.println("bidToUpdate: " +
			// utilitySpace.getUtility(bidToUpdate));

			this.addBid(bidToUpdate, utilitySpace);
			// System.out.println("Finish Adding Bid!");
			//
			// System.out.println("bidToUpdate: " +
			// utilitySpace.getUtility(bidToUpdate));

			// if (!bidCounter.containsKey(bidToUpdate)) {
			// System.out.println("Not ContainKey!");
			// }
			// else
			// {
			...
			if (!bidCounter.containsKey(bidToUpdate)) {
				...
				// System.out.println("Running: Not ContainKey!");
			} else {
				int counter = bidCounter.get(bidToUpdate);
				counter++;
				bidCounter.put(bidToUpdate, counter);
				// System.out.println("Running: ContainKey!");
			}
			// System.out.println("Finish HashMap!");
			/*
			...
			// System.out.println("End updateOpponentModel!");
		} catch (Exception e) {
			System.out.println("updateOpponentModel error" + e.getMessage());
		}
	}
