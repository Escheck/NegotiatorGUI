...
public class EnterBidDialog2 extends JDialog implements EnterBidDialogInterface {
    ...
    public EnterBidDialog2(NegotiationParty party, Frame parent, boolean modal, UtilitySpace us, boolean canEndNegotiation)  throws Exception
    {
        super(parent, modal);
        this.party = party;
    ...
    public negotiator.actions.Action askUserForAction(negotiator.actions.Action opponentAction, Bid myPreviousBid, Bid mostRecentOffer) {
