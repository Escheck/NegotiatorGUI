...
public class OpponentModelling {
	...
	private ArrayList<Issue> domainIssues = new ArrayList<Issue>();
	...
	// initialization
	public OpponentModelling(String senderAgent, ArrayList<Issue> domIss, Bid b) {
		domainIssues = domIss;
	...
	public Offer maxOppUtilBid(ArrayList<Bid> bidList) {
		try {
			...
			return new Offer(bidList.get(maxIndex));
		} catch (Exception e) {
			System.err
