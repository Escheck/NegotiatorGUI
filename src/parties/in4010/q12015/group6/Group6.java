...
public class Group6 extends AbstractNegotiationParty {
	...
	public void receiveMessage(java.lang.Object sender, Action opponentAction) {
		...
		if (actionOfPartner instanceof Offer) {
			Bid oppBid = ((Offer) actionOfPartner).getBid();
