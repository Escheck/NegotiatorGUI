...
//	public static PrintStream writePreferenceStream;
	...
	public void init() {
		...
		/*if (getSessionNo()==1)
			try{
				FileOutputStream fileResultStream = new FileOutputStream("NegoPreferenceModels.dat");   
				writePreferenceStream=new PrintStream(fileResultStream);
			} catch (Exception e) {
					System.err.print(e);
			}	*/
	 }
	...
	public Action chooseAction(ArrayList<Class> validActions) {
		...
		try {
		     ...
		     if (validActions.contains(NoAction.class)){
				...
				System.out.println(getRound()+" :Cannnot generate random bid or update preference list problem:" +e.getMessage());
