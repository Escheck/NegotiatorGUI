...
public class ConsensusVotingHumanAgent extends AbstractNegotiationParty {
     ...
     */
    public ConsensusVotingHumanAgent(
        ...
        try {
            ui = new EnterBidDialogOfferForVoting(this, null, true, utilitySpace);
        } catch (Exception e) {
    ...
    public Action chooseAction(List<Class> possibleActions) {
        ...
        try {
            if (possibleActions.contains(Accept.class)) {
                ...
                ui = new EnterBidDialogAcceptReject(this, null, true, utilitySpace, topic);
            }
            else {
                ui = new EnterBidDialogOfferForVoting(this, null, true, utilitySpace);
            }
