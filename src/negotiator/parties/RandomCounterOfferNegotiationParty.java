 ...
 * @author David Festen
 */
public class RandomCounterOfferNegotiationParty extends
	...
	public Action chooseAction(List<Class> possibleActions) {
		...
		return timeline.getTime() >= 0.9 ? new Accept(getPartyId())
	...
	public AgentID getPartyId() {
		return (partyId == null ? new AgentID(String.format("Random#%4s",
				hashCode())) : partyId);
	}
}
