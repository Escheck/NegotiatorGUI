 ...
 * <p/>
 * This class was adapted from Reyhan's parties.PureRandomFlippingMediator class (see svn history
 * for details about that class), and adapted to fit into the new framework.
 */
public class RandomFlippingMediator extends Mediator {
     ...
     */
    public RandomFlippingMediator(UtilitySpace utilitySpace, Map<DeadlineType, Object> deadlines,
     ...
     * {@link negotiator.protocol.Protocol#getRoundStructure(java.util.List,
    ...
    public Action chooseAction(List<Class> possibleActions) {
        ...
        if (possibleActions.contains(OfferForVoting.class)) {
            ...
            return new InformVotingResult(mediatorId, isAcceptable ? Vote.ACCEPT : Vote.REJECT);
        } else {
            return null;
        }
    }
    ...
    private Bid modifyLastBidRandomly() {
        try {
            ...
            System.out.println("Can not generate random bid or receiveMessage preference list "
