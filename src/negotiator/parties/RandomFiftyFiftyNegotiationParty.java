...
public class RandomFiftyFiftyNegotiationParty extends AbstractNegotiationParty {
    /**
     * Initializes a new instance of the {@link RandomFiftyFiftyNegotiationParty} class.
     *
     ...
     */
    public RandomFiftyFiftyNegotiationParty(UtilitySpace utilitySpace, Map<DeadlineType, Object>
    ...
    public AgentID getPartyId() {
        return (partyId == null ? new AgentID("Random50/50@" + hashCode()) : partyId);
    }
}
