...
/**
 * Error that will be thrown when an action that is not valid for the given round. At this moment
 * (September 2014) The {@link negotiator.session.SessionManager} detects these invalid actions and
 * throws this error.
 */
public class InvalidActionError extends Exception
{
     ...
     *
     * @param instigator The party that did an invalid action.
     */
     ...
     */
    @SuppressWarnings("UnusedDeclaration") // might be used in future
