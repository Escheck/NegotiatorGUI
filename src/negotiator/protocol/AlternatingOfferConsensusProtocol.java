...
public class AlternatingOfferConsensusProtocol extends ProtocolAdapter {
     ...
     * responding to a {@link negotiator.parties.NegotiationParty#chooseAction(java.util.List)} event, and the
     * value is  a list of {@link negotiator.parties.NegotiationParty} that are listening to that key party's
     * response.
     */
    @Override
