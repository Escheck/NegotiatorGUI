...
/**
 *
 * @author Reyhan Aydogan Based on Agent Class written by Dmytro and Wouter
 *
...
public abstract class Party {
	...
	public void setParametervalues(
			HashMap<AgentParameterVariable, AgentParamValue> parametervalues) {
	 ...
	 * This function will be called when the agent is killed, typically when it
	 * was timed out in a nego session. The agent will not be able to do any
	 * negotiation actions here, just clean up. To ensure that the agent can not
	...
	protected Value getRandomValue(Issue currentIssue) throws Exception {
		...
		case REAL:
			...
			index = randomnr.nextInt(lIssueReal
					.getNumberOfDiscretizationSteps()); // check this!
