 ...
 *         memory leaks.
 */
public class TournamentProgressUI2 extends javax.swing.JPanel implements
	...
	/**
	 * modified Wouter 4nov08: SesssionDetailsUI contains list of pairs <session
	 * number, ProgressUI>
	 */
	...
	public TournamentProgressUI2(ProgressUI2 pUI) {
		...
		String[] colNames = { "Prof. A", "Prof. B", "AgentA", "AgentB",
				"AgentA params", "AgentB params", "Rounds", "utilA", "utilB",
				"utilA discount", "utilB discount", "Time" };
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(TournamentProgressUI2.class);
		pnlTournamentOverView.setBorder(javax.swing.BorderFactory
				.createTitledBorder(resourceMap
						.getString("pnlTournamentOverView.border.title"))); // NOI18N
		...
		pnlTournamentOverViewLayout
				.setHorizontalGroup(pnlTournamentOverViewLayout
						.createParallelGroup(
								...
								390, Short.MAX_VALUE));
		pnlTournamentOverViewLayout
				.setVerticalGroup(pnlTournamentOverViewLayout
						.createParallelGroup(
								org.jdesktop.layout.GroupLayout.LEADING).add(
								jScrollPane1,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
		...
		pnlSession.setBorder(javax.swing.BorderFactory
				.createTitledBorder(resourceMap
						.getString("pnlSession.border.title"))); // NOI18N
		...
		org.jdesktop.layout.GroupLayout pnlSessionLayout = new org.jdesktop.layout.GroupLayout(
				pnlSession);
		pnlSession.setLayout(pnlSessionLayout);
		pnlSessionLayout.setHorizontalGroup(pnlSessionLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(jPanel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE));
		pnlSessionLayout.setVerticalGroup(pnlSessionLayout.createParallelGroup(
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(
				org.jdesktop.layout.GroupLayout.TRAILING, jSplitPane1,
				org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 306,
				Short.MAX_VALUE));
	...
	public void handleActionEvent(ActionEvent evt) {
		...
		if ((evt.getAct() instanceof EndNegotiation)
				|| (evt.getAct() instanceof Accept) || evt.isFinalActionEvent()) {
			// System.out.println("end or accept --> fill table");
			resultTable.getModel().setValueAt(evt.getRound(), session - 1, 6);// rounds
			resultTable.getModel().setValueAt(evt.getNormalizedUtilityA(),
					session - 1, 7);// util a
			resultTable.getModel().setValueAt(evt.getNormalizedUtilityB(),
					session - 1, 8);// util b
			resultTable.getModel().setValueAt(evt.getUtilADiscount(),
					session - 1, 9);// util a
			resultTable.getModel().setValueAt(evt.getUtilBDsicount(),
					session - 1, 10);// util b
	...
	public void handleBlateralAtomicNegotiationSessionEvent(
		...
		if (!(negoSession.getAgentAparams() == null)) {
			for (Entry<AgentParameterVariable, AgentParamValue> entry : negoSession
					.getAgentAparams().entrySet()) {
				agentAParams += entry.getKey().varToString() + " "
		...
		if (!(negoSession.getAgentBparams() == null)) {
			for (Entry<AgentParameterVariable, AgentParamValue> entry : negoSession
					.getAgentBparams().entrySet()) {
				agentBParams += entry.getKey().varToString() + " "
						+ entry.getValue().toString();
				i++;
			}
		...
		resultTable.getModel().setValueAt(evt.getProfileA().getName(),
				session - 1, 0);// profile 1
		resultTable.getModel().setValueAt(evt.getProfileB().getName(),
				session - 1, 1);// profile 2
