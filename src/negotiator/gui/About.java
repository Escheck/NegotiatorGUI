...
public class About extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		contributorsValueScrollPane.setBackground(new java.awt.Color(255, 255,
				255));
		...
		Icon icon = new ImageIcon(getClass().getClassLoader().getResource(
				"negotiator/gui/resources/GeniusLogo.png"));
		...
		websiteValueLabel.setText("<html><a href=\"\">" + GENIUSLINK
				+ "</a></html>");
		...
		geniusDescriptionScrollPane.setBackground(new java.awt.Color(255, 255,
				255));
