...
public class BOAagentsFrame extends JDialog {
    ...
    public ArrayList<BOAagentInfo> getResult(ArrayList<BOAagentInfo> BOAagentList) {
    	nullParam = new BOAparameter("null", BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE);
    	initFrameUI();
    ...
    private void initBiddingStrategyUI() {
    	...
    	biddingStrategyCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	BOArepItem item = BOAagentRepository.getInstance().getBiddingStrategyRepItem(biddingStrategyCB.getSelectedItem().toString());
    	...
    	change.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	if (biddingStrategyTF.getBOAparameters().size() == 0) {
            		...
            		ArrayList<BOAparameter> result = new ParameterFrame(NegoGUIApp.negoGUIView.getFrame()).getResult(biddingStrategyTF.getBOAparameters());
    ...
    private void initOpponentModelUI() {
    	...
    	opponentModelCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	BOArepItem item = BOAagentRepository.getInstance().getOpponentModelRepItem(opponentModelCB.getSelectedItem().toString());
    	...
    	change.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	if (opponentModelTF.getBOAparameters().size() == 0) {
            		...
            		ArrayList<BOAparameter> result = new ParameterFrame(NegoGUIApp.negoGUIView.getFrame()).getResult(opponentModelTF.getBOAparameters());
    ...
    private void initAcceptanceStrategyUI() {
    	...
    	acceptanceStrategyCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	BOArepItem item = BOAagentRepository.getInstance().getAcceptanceStrategyRepItem(acceptanceStrategyCB.getSelectedItem().toString());
    	...
    	change.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	if (acceptanceStrategyTF.getBOAparameters().size() == 0) {
            		...
            		ArrayList<BOAparameter> result = new ParameterFrame(NegoGUIApp.negoGUIView.getFrame()).getResult(acceptanceStrategyTF.getBOAparameters());
    ...
    private void initOpponentModelStrategyUI() {
    	...
    	omStrategyCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	BOArepItem item = BOAagentRepository.getInstance().getOpponentModelStrategyRepItem(omStrategyCB.getSelectedItem().toString());
    	...
    	change.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	if (omStrategyTF.getBOAparameters().size() == 0) {
            		...
            		ArrayList<BOAparameter> result = new ParameterFrame(NegoGUIApp.negoGUIView.getFrame()).getResult(omStrategyTF.getBOAparameters());
    ...
    private void initAgentsListUI() {
    	...
    	getContentPane().add(boaAgentsLabel, new AbsoluteConstraints(10, 140, -1, -1));
    ...
    private void initButtons() {
    	...
    	getContentPane().add(saveButton, new AbsoluteConstraints(10, 465, 105, -1));
    }
	...
	private Set<BOAcomponent> generateStrategies(String classname,
		...
		Set<Set<Pair<String, BigDecimal>>> result = SetTools.cartesianProduct(params);
		
		Set<BOAcomponent> strategies = new HashSet<BOAcomponent>();
		Iterator<Set<Pair<String, BigDecimal>>> combinationsIterator = result.iterator();
