...
public class ParameterFrame extends JDialog {
	...
	public ArrayList<BOAparameter> getResult(ArrayList<BOAparameter> input) {
    	this.result = input;
		generateFrame();
		generateLabels();
        generateInput();
	...
	private void generateButtons() {
		...
		getContentPane().add(okButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(leftSideBorder, (result.size() * elementHeight) + lowerBorder, buttonWidth, buttonHeight));
		...
		getContentPane().add(cancelButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(leftSideBorder + buttonWidth + 20, (result.size() * elementHeight) + lowerBorder, buttonWidth, buttonHeight));
	...
	private void generateLabels() {
        ...
        getContentPane().add(description, new org.netbeans.lib.awtextra.AbsoluteConstraints(leftSideBorder + nameWidth, higherBorder, descriptionWidth, labelHeight));
        
		JLabel lowerBound = new JLabel("Lower bound");
		lowerBound.setFont(new java.awt.Font("Tahoma", 1, 13));
        getContentPane().add(lowerBound, new org.netbeans.lib.awtextra.AbsoluteConstraints(leftSideBorder + nameWidth + descriptionWidth, higherBorder, lowerBoundWidth, labelHeight));
        
        JLabel stepSize = new JLabel("Step size");
        stepSize.setFont(new java.awt.Font("Tahoma", 1, 13));
        getContentPane().add(stepSize, new org.netbeans.lib.awtextra.AbsoluteConstraints(leftSideBorder + nameWidth + descriptionWidth + lowerBoundWidth, higherBorder, stepSizeWidth, labelHeight));
        
        JLabel upperBound = new JLabel("Upper bound");
        upperBound.setFont(new java.awt.Font("Tahoma", 1, 13));
        getContentPane().add(upperBound, new org.netbeans.lib.awtextra.AbsoluteConstraints(leftSideBorder + nameWidth + descriptionWidth + lowerBoundWidth + stepSizeWidth, higherBorder, higherBoundWidth, labelHeight));
	}
	...
	private void generateInput() {
		...
		for (int i = 0; i < result.size(); i++) {
	        ...
	        getContentPane().add(label, new org.netbeans.lib.awtextra.AbsoluteConstraints(leftSideBorder, labelHeight + higherBorder+ i * elementHeight, nameWidth - spacing, -1));
	        ...
	        getContentPane().add(descriptionTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(leftSideBorder + nameWidth, labelHeight + higherBorder + i * elementHeight, descriptionWidth - spacing, -1));
	...
	private void generateFrame() {
    	...
    	int width = leftSideBorder + nameWidth + descriptionWidth + lowerBoundWidth + stepSizeWidth + higherBoundWidth + leftSideBorder;
