...
public class ParameterInput extends JDialog {
    ...
    private DecoupledParameter result = null;
     ...
     */
    public DecoupledParameter getResult() {
    	initFrameGUI();
    	initParamNameGUI();
    	initValueRangeGUI();
    	initButtonsGUI();
    			...
    			if (name.equals("")) {
	    			...
	    			try {
	    				...
	    				if (highTextField.getText().equals("") && stepTextField.getText().equals("")) {
	        				result = (new DecoupledParameter(name, low, low, 1));
	        			} else {
		    				try {
		        				...
		        				try {
		            				...
		            				try {
		                				...
		                				if (high >= low && step > 0) {
		                    				result = new DecoupledParameter(name, low, high, step);
		                    			} else {
