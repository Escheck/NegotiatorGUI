...
public class IAMhagglerBayesianModel extends OpponentModel {
	...
	public void init(NegotiationSession negotiationSession,
		...
		if (parameters != null && parameters.containsKey("u")
				&& parameters.get("u") > 0.0) {
			useAll = true;
		}
		opponentConcessionFunction = new TimeConcessionFunction(beta,
	...
	public Set<BOAparameter> getParameters() {
		...
		set.add(new BOAparameter("u", new BigDecimal(0.0),
				"Use all bids (instead of only unique) if u > 0.0"));
		set.add(new BOAparameter("b", new BigDecimal(1.0),
				"Concession speed e of assumed opponent TDT function"));
		return set;
	}
}
