...
public class AC_InoxAgent_OneIssue extends AcceptanceStrategy {
	...
	public Actions determineAcceptability() {
		...
		if (!medianDecided) {
			...
			int opplocation = outcomespace.getIndexOfBidNearUtility(negotiationSession.getOpponentBidHistory().getBestBidDetails().getMyUndiscountedUtil());
		...
		} else if (negotiationSession.getUtilitySpace().getReservationValueUndiscounted() >= medianutil*Math.pow(discountFactor, time)) {
