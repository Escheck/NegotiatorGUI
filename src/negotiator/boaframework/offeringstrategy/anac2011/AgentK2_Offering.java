    ...
    private BidDetails searchBid() throws Exception {
        ...
        for (Issue lIssue : issues) {
            ...
            case DISCRETE:
                ...
                int optionIndex = random300.nextInt(lIssueDiscrete
                        .getNumberOfValues());
                values.put(lIssue.getNumber(), lIssueDiscrete
                        .getValue(optionIndex));
                break;
            case REAL:
                IssueReal lIssueReal = (IssueReal) lIssue;
                int optionInd = random300.nextInt(lIssueReal
                        .getNumberOfDiscretizationSteps() - 1);
                values.put(lIssueReal.getNumber(), new ValueReal(
        ...
        bid = new BidDetails(newBid, negotiationSession.getUtilitySpace().getUtility(newBid), negotiationSession.getTime());
        return bid;
    }
