 ...
 * then the breakoff is set to this utility for the next session on this preference profile.
 * If there is no accept, then the target is decreased with a predefined constant.
 * 
