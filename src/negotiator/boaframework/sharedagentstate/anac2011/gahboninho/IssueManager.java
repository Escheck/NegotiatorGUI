...
public class IssueManager
{
	...
	private double Noise = 0.4; // 0 to 1 - Tells us how varied the opponent's bids are, lately
	// My State:
	...
	public void ProcessOpponentBid (Bid IncomingBid) throws Exception
	{
		...
		else
		{
			...
			{
				setNoise(getNoise() + 0.05); // opponent is trying harder to search
			}
			...
			{
				setNoise(getNoise() + NoiseDecreaseRate); // Apparently, the opponent just gave up some of his util
			}
			else 
			{
