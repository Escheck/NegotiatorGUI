...
public class OpponentBidLists {
	...
	public ArrayList<Entry<Pair<Integer,Value>, Integer>> getMostFrequentIssueValues(Object sender) {
		...
		ArrayList<Entry<Pair<Integer,Value>, Integer>> sorted_list = new ArrayList<Entry<Pair<Integer,Value>, Integer>>(((Map<Pair<Integer,Value>, Integer>)value_count).entrySet());
		Collections.sort(sorted_list, new Comparator<Entry<Pair<Integer,Value>, Integer>>()
		        {
	...
	public ArrayList<Entry<Pair<Integer,Value>, Double>> weightIssueValues(ArrayList<Entry<Pair<Integer,Value>, Integer>> sorted_list) {
		...
		ArrayList<Entry<Pair<Integer,Value>, Double>> weighted_list = new ArrayList<Entry<Pair<Integer,Value>, Double>>(((Map<Pair<Integer,Value>, Double>)map).entrySet());
