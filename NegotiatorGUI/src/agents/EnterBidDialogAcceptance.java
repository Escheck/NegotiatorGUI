 ...
 * @author David festen
 */
public class EnterBidDialogAcceptance extends JDialog implements EnterBidDialogInterface
{
    ...
    public EnterBidDialogAcceptance(NegotiationParty party, Frame parent, boolean modal, UtilitySpace us) throws Exception
    {
        super(parent, modal);
        this.party = party;
    ...
    private void buttonAcceptActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        if (bid != null)
        {
            ...
            selectedAction = new VoteForOfferAcceptance(party.getPartyId(), Vote.ACCEPT);
            setVisible(false);
        }
    }
    ...
    private void buttonRejectActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        if (bid != null)
        {
            ...
            selectedAction = new VoteForOfferAcceptance(party.getPartyId(), Vote.REJECT);
            setVisible(false);
        }
    }
    ...
    private void buttonExitActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        selectedAction = new IllegalAction(party.getPartyId(), "Exiting application");
        this.dispose();
    }
    ...
    public negotiator.actions.Action askUserForAction(negotiator.actions.Action opponentAction, Bid currentOffer, Bid lastAcceptedOffer)
    {
