 ...
 * @author  W.Pasman
 */
public class EnterBidDialogOffer extends JDialog implements EnterBidDialogInterface {
    ...
    public EnterBidDialogOffer(NegotiationParty party, Frame parent, boolean modal, UtilitySpace us)  throws Exception
    {
        super(parent, modal);
        this.party = party;
