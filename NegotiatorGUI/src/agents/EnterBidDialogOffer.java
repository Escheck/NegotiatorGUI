 ...
 * @author W.Pasman
 */
public class EnterBidDialogOffer extends JDialog implements
	...
	public EnterBidDialogOffer(AbstractNegotiationParty party, Frame parent,
			boolean modal, AdditiveUtilitySpace us) throws Exception {
		super(parent, modal);
		this.party = party;
