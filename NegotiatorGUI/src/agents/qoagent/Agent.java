...
{
	//general variables
	private ServerThread m_st; //Allows access to the agent's thread at the server
	...
	* Output: None.
	******************************************************************/
	public Agent(MultiServer server,ServerThread st,boolean SupportMed,String sSide)
	{
		m_nOptOutNum = 0;
		m_nResponsesNum = 0;
		m_nAcceptsNum = 0;
	...
	****************************************************************/
	...
	{
		m_gtEndNeg = new GameTimeServer(bCountUp,nHours,nMinutes,nSeconds,this,bTurnOrNeg,nMaxTurn,m_server,m_st);
	}
	...
	****************************************************************/
	...
	{
		m_gtEndTurn = new GameTimeServer(bCountUp,nHours,nMinutes,nSeconds,this,bTurnOrNeg,nMaxTurn,m_server,m_st);
	}
