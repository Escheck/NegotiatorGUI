 ...
 * @author  David festen
 */
public class EnterBidDialogAcceptReject extends JDialog implements EnterBidDialogInterface {
    ...
    public EnterBidDialogAcceptReject(NegotiationParty party, Frame parent, boolean modal, UtilitySpace us, Bid topic)  throws Exception
    {
    ...
    private void initThePanel() {
    	if (negoOffer ==null) throw new NullPointerException("negoOffer is null");
    ...
    private void buttonRejectActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (bid!=null) {
            ...
            selectedAction= new Reject(party.getPartyId());
            setVisible(false);
        }
    }
    ...
    askUserForAction(negotiator.actions.Action opponentAction, Bid votingTopic)
    {
        ...
        BidTable.setDefaultEditor(BidTable.getColumnClass(0),new MyCellEditor(negoOffer));
