...
public class IAMhagglerModel extends OpponentModel {
	...
	public void init(NegotiationSession negotiationSession, HashMap<String, Double> parameters) throws Exception {
		...
		opponentConcessionFunction = new TimeConcessionFunction(0.3, TimeConcessionFunction.BREAKOFF);
	...
	public void updateModel(Bid opponentBid) {
		...
		previousBidUtility = opponentConcessionFunction.getConcession(1, negotiationSession.getTime(), 1.0);
