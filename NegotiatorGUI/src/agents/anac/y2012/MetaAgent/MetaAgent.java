...
public class MetaAgent extends Agent {
	...
	private void getDomainParams(){
		...
		params[1] = this.utilitySpace.getDiscountFactor() == 0 ? 1 : this.utilitySpace.getDiscountFactor(); //1 = discount factor.
	...
	private Agent selectAgent(String name){
		...
		if (name.equalsIgnoreCase("IAMcrazyhaggler")) return a;///agent doesn't work
		else if (name.equalsIgnoreCase("LYYAgent")) return new LYYAgent();
		else if (name.equalsIgnoreCase("Chameleon")) return new Chameleon();
		else if (name.equalsIgnoreCase("AgentSmith")) return new AgentSmith();
		else if (name.equalsIgnoreCase("GYRL")) return new GYRL();
		else if (name.equalsIgnoreCase("Gahboninho")) return new Gahboninho();
		else if (name.equalsIgnoreCase("ValueModelAgent")) return new ValueModelAgent();
		else if (name.equalsIgnoreCase("Nice Tit-for-Tat Agent")) return a;///agent doesn't work
		else if (name.equalsIgnoreCase("HardHeaded")) return new KLH();
		else if (name.equalsIgnoreCase("WinnerAgent")) return new WinnerAgent2();
		else if (name.equalsIgnoreCase("AgentK2")) return new Agent_K2();
		else if (name.equalsIgnoreCase("TheNegotiator")) return new TheNegotiator();
		else if (name.equalsIgnoreCase("IAMhaggler2011")) return a;///agent doesn't work
		else if (name.equalsIgnoreCase("DNAgent")) return new DNAgent();
		else if (name.equalsIgnoreCase("BRAMAgent")) return new BRAMAgent();
		else if (name.equalsIgnoreCase("MrFriendly")) return new MrFriendly();
		else if (name.equalsIgnoreCase("ShAgent")) return new ShAgent();
		else if (name.equalsIgnoreCase("simpleAgent")) return new SimpleAgentNew();
		else return a;
