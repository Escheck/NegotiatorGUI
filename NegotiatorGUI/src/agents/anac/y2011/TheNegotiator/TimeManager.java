...
public class TimeManager {
	...
	private void calculateEndPhaseThresholds() {
		...
		maxThresArray1[3] = bidsCollection.getPossibleBids().get(bidsCollection.getPossibleBids().size() - 1).getMyUndiscountedUtil();
	...
	public void calculatePropArray() {
		...
		double min = bidsCollection.getPossibleBids().get(bidsCollection.getPossibleBids().size() - 1).getMyUndiscountedUtil();
		...
		if(propArray[0] == 0) {
			...
			maxThresArray2[1] = bidsCol.get(propArray[0] - 1).getMyUndiscountedUtil(); // -1 to correct for array offset of zero
		}
