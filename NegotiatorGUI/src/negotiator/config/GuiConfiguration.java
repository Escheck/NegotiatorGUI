...
/**
 * This is the configuration object used by the user interface. It stores all the data used there.
 *
 * @author David Festen
 */
public interface GuiConfiguration
{
     ...
     *
     * @param mediatorProfile the mediator's profile rep item or null if not existing
     */
     ...
     */
    HashMap<DeadlineType, Object> getDeadlines();
     ...
     */
    void setDeadlines(HashMap<DeadlineType, Object> deadlines);
     ...
     *
     * @param numRounds the number of sessions
     */
