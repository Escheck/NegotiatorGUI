...
public class MultiPhaseAuctionOldProtocol extends AuctionOldProtocol
{
	...
	public MultiPhaseAuctionOldProtocol(AgentRepItem[] agentRepItems,
...
*/
	...
	protected static AuctionOldProtocol createSession(Tournament tournament,ProfileRepItem profileCenter, ProfileRepItem profileSeller1, ProfileRepItem profileSeller2) throws Exception {
		...
		params[1] = paramsB;
		params[2] = paramsB;
		MultiPhaseAuctionOldProtocol session = new MultiPhaseAuctionOldProtocol(agents,  profiles,	params, 0, 1) ;
		return session;
