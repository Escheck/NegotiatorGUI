...
public class AuctionProtocol extends Protocol {
	...
	protected void calculateTheoreticalOutcome() {
		try {
			...
			for (int i = 0; i < numberOfSellers; i++) {
				AdditiveUtilitySpace centerUtilitySpace = (AdditiveUtilitySpace) getAgentUtilitySpaces(0);
				AdditiveUtilitySpace sellerUtilitySpace = (AdditiveUtilitySpace) getAgentUtilitySpaces(1 + i);
			...
			AdditiveUtilitySpace centerUtilitySpace = (AdditiveUtilitySpace) getAgentUtilitySpaces(0);
			AdditiveUtilitySpace sellerUtilitySpace = (AdditiveUtilitySpace) getAgentUtilitySpaces(1 + winner);
	...
	public void run() {
		try {
			...
			AuctionBilateralAtomicNegoSession secondPhaseSession = runNegotiationSession(
					...
					(AdditiveUtilitySpace) getAgentUtilitySpaces(0),
					(AdditiveUtilitySpace) getAgentUtilitySpaces(1 + winnerSessionIndex),
					paramsA, paramsB);
	 ...
	 * result in the global field "outcome" // * @param nr is the
	 * sessionTestNumber
	 * 
	 * @throws Exception
	 * 
