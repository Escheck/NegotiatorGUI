 ...
 */
public class AlternatingOffersOldProtocol extends OldProtocol
{
	...
	public AlternatingOffersOldProtocol(AgentRepItem[] agentRepItems, ProfileRepItem[] profileRepItems,
...
//		System.out.println("Found value for preference profile B: " + rvBString );
	 ...
	 *             variable.
	 */
	protected static ArrayList<AlternatingOffersOldProtocol> allParameterCombis(Tournament tournament,
			...
			throws Exception
	{
		...
		allparameters.addAll(tournament.getParametersOfAgent(agentB, AGENT_B_NAME)); // are
																						...
																						// names
																						// somewhere?
		ArrayList<AlternatingOffersOldProtocol> sessions = new ArrayList<AlternatingOffersOldProtocol>();
	...
	protected static void allParameterCombis(Tournament tournament, ArrayList<AssignedParameterVariable> allparameters,
			ArrayList<AlternatingOffersOldProtocol> sessions, ProfileRepItem profileA, ProfileRepItem profileB,
			AgentRepItem agentA, AgentRepItem agentB, ArrayList<AssignedParamValue> chosenvalues) throws Exception
	{
		...
		if (allparameters.isEmpty())
		{
			...
			AlternatingOffersOldProtocol session = new AlternatingOffersOldProtocol(agents, profiles, params,
					numberOfSessions);
