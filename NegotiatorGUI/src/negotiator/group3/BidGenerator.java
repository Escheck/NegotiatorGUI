...
public class BidGenerator {
	...
	public static double[] utilitylist(ArrayList<Bid> bids, Group3 info){
	 ...
	 * */
	public static ArrayList<Bid> getBidsInRange(ArrayList<Bid> bids, double low_bound, double up_bound, Group3 info)
	{
