...
public class CloseTabPaneEnhancedUI extends CloseTabPaneUI {
	...
	//Wouter: this color seems way off to me, both for windows and OSX?
    private static final Color selectedColor = new Color(131, 188, 249);
    ...
    protected void paintTabBackground(Graphics g, int tabPlacement,
        ...
        if (isSelected) {
            ...
            g2.fillRect(x + 2, y + 2, w-delta2 , h - 2);
        }
    }

    protected void paintTabBackgroundOld(Graphics g, int tabPlacement,
            int tabIndex, int x, int y, int w, int h, boolean isSelected) {
        if (isSelected) {
    ...
    protected void paintText(Graphics g, int tabPlacement, Font font,
        ...
        if (v != null) {
            ...
            if (tabPane.isEnabled() && tabPane.isEnabledAt(tabIndex)) {
                /*Wouter: always black is usual in Win and OSX.
				if (isSelected){
