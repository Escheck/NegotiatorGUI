 ...
 * Every unique combination of an agent class name and a preference
 * profile name will be saved in a different file; for identification.
 * @author Samanta H.
 *
 */
public class DataObjects {
	 ...
	 * It creates a unique name (concatenating the agent class name and 
	 * the preference profile file name) to be the name of the file which 
	 * will contain dataToSave.
	 * @param dataToSave a {@link Serializable} object to save
	 * @param agentClassName is the class name of the agent who wants to save the data
	 * @param prefProfName is the preference profile for which the agent wants to save data
	 * @return true if dataToSave was saved successfully
	 * 		   false otherwise.
	 */
	 ...
	 * It identifies the data by a unique name (concatenating the agent class name and 
	 * the preference profile file name) which is the name of the file containing 
	 * the data.
	 * 
	 * @param agentClassName is the class name of the agent who wants to load the data
	 * @param prefProfName is the preference profile for which the agent wants to load the data
	 * @return the data that was saved by the agent when he was in the role of the preference
	 * 	       profile filename.
	 */
