...
public class AC_CombiMaxInWindow extends AcceptanceStrategy {
	...
	public AC_CombiMaxInWindow(NegotiationSession negoSession,
			OfferingStrategy strat, double t) {
	...
	public Set<BOAparameter> getParameters() {
		...
		set.add(new BOAparameter("t", new BigDecimal(0.98),
				"Time t after which the agent may accept"));
