...
public class AC_CombiV4 extends AcceptanceStrategy {
	...
	public AC_CombiV4(NegotiationSession negoSession, OfferingStrategy strat,
		...
		if (negotiationSession.getDiscountFactor() < 0.00001
				|| negotiationSession.getDiscountFactor() > e) {
	...
	public void init(NegotiationSession negoSession, OfferingStrategy strat,
		...
		if (parameters.get("a") != null || parameters.get("b") != null
				|| parameters.get("c") != null && parameters.get("d") != null
				&& parameters.get("e") != null) {
			a = parameters.get("a");
			b = parameters.get("b");
			c = parameters.get("c");
			d = parameters.get("d");
	...
	public Set<BOAparameter> getParameters() {
		...
		set.add(new BOAparameter("c", new BigDecimal(1.0),
				"Multiplier discount"));
		set.add(new BOAparameter("d", new BigDecimal(0.0), "Constant discount"));
		set.add(new BOAparameter("e", new BigDecimal(0.8), "Threshold discount"));
