...
public class AC_CombiV3 extends AcceptanceStrategy {
	...
	public AC_CombiV3(NegotiationSession negoSession, OfferingStrategy strat,
			double a, double b, double t, double c) {
	...
	public Set<BOAparameter> getParameters() {
		...
		set.add(new BOAparameter("c", new BigDecimal(0.95), "Threshold"));
