 ...
 * 
 * The utility of offers that are being generated slowly decline to
 * the utility of the median bid between our best bid and the 
 * opponent's first bid.
 * 
...
public class InoxAgent_Offering_OneIssue extends OfferingStrategy {
	...
	/**
	 * Function that generates a bid to send based on time
	 * and discount factor.
	 */
	private BidDetails calculateBid(double t) {
		// If dealing with a discounted domain, transform this function such that
