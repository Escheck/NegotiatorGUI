...
public class ActionEvent extends NegotiationEvent {
	...
	public ActionEvent(Object source, Agent actorP, Action actP, int roundP,
			long elapsed, double t, double utilA, double utilB,
			double utilADiscount, double utilBDsicount, String remarks,
			boolean finalActionEvent) {
		super(source);
		actor = actorP;
		act = actP;
	...
	public String toString() {
		return "ActionEvent[" + actor + "," + act + "," + round + ","
				+ elapsedMilliseconds + "," + normalizedUtilityA + ","
