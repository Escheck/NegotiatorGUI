...
\begin{description}
  ...
  \item[Opponent model strategy] Specifies how the opponent model is used. An example is to select the best bid for the opponent given a set of similarly preferred bids.
...
\begin{figure}[t] 
	\center
	\includegraphics[width=14cm]{media/BOAflow.png}
...
\begin{figure}[h!] 
	\center
	\includegraphics[width=12cm]{media/BOAparam.png}
