...
There are actually 2 ways to do this: using the zip file from the release page and using maven.
...
\subsection{Connect using the jar from the release page}
...
\item{Add the \texttt{genius-XXX} Jar:
	\begin{enumerate}
		...
		\item Open the \texttt{AI2016Group3assignment} folder and scroll down to select \texttt{genius-XXX.jar}.
		\item Click OK once.
...
\begin{figure}[h!]
	\centering
		...
		\caption{Attach the genius-XXX jar to the project.}
