...
Given this property, multi acceptance criteria can be tested in parallel during the same negotiation trace. In practice, we noted that more than 50 variants of $\textbf{AC}_{next}$ could be tested in the same negotiation at a negligible computational cost.
