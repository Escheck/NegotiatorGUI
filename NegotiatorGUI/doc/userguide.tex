...
\subsection{Creating a ANAC2013 Agent}
...
A single serializable object can be saved per preference profile by using the \textit{saveSessionData} method. If an object was already saved for the preference profile it is replaced. The saved object can be requested by using the \textit{loadSessionData} method. Note that this functionality is also available to BOA agents.
