...
You start \Genius by double-clicking the application or using "open with" and then selecting Java. 
...
Every agent must at least implement \texttt{negotiator.parties.NegotiationParty} i, 

Also your implementation must have a public default (no-argument) constructor.

This section discusses details of implementing a NegotiationParty.  Please refer to the javadocs for details on the parameters.
...
The examples extend AbstractNegotiationParty which is a basic implementation of NegotiationParty. Table \ref{tab:agentclass} shows the most important fields and methods of this class. For more information, please refer to the javadoc of \Genius. To implement your agent, you have to override the three methods: \textit{ReceiveMessage}, \textit{init}, and \textit{chooseAction}.
