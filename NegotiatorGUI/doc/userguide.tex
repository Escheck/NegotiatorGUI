...
\begin{itemize}
    \item \textbf{deadline}. The deadline element contains two values:
      \begin{itemize}
        \item \textbf{totalTime}. This is the maximum time in seconds for each session. Ignored if \textless 1
        \item \textbf{totalRounds.} This is the maximum number of rounds for each session. Ignored if \textless 1.
      \end{itemize}
