...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.65\textwidth]{media/multipartysession.png}
\caption{A negotiation session.}\label{Fig:multipartysession}
\end{figure}
...
The negotiation is started when you press the start button. The tab contents will switch into  a progress overview panel
showing you the results of the negotiation.
