...
To implement a multi-party negotiation party, at a minimum one needs to implement a class that implements the \\texttt{negotiator.parties.NegotiationParty} interface. Also your implementation must have a public default (no-argument) constructor. To implement the interface, one needs to implement five functions: 

\begin{lstlisting}
public interface NegotiationParty {
	/**
	 * Initializes the party. Informs this party which utility space and
	 * timeline the party is running in. This replaces the standard constructor.
	 * This MUST be called exactly once, by the code that instantiates this
	 * class, immediately after instantiation.
	 * 
	 * @param utilSpace
