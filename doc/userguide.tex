...
The negotiation environment has been tested extensively on Mac OSX and Microsoft Windows. It should run on any machine running Java 6 or higher. This includes Solaris and Linux distributions. There are known issues with Linux (in particular Ubuntu and SUSE) mainly involving the visualization of the GUI. There are still a number of known bugs in the negotiation environment, but these should be non critical. Please report any bugs found to \url{ai@mmi.tudelft.nl}.
