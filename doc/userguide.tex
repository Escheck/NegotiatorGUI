...
\item execute the command \texttt{javac -cp negosimulator.jar -source 1.7 -target 1.7  examplepackage/ExampleAgent.java}
\end{itemize}
...
\item Open a terminal 
\item Switch to the root directory of genius
\item Enter the command \texttt{javac -cp negosimulator.jar -source 1.7 -target 1.7 boaexamplepackage/*.java }
\end{itemize}
